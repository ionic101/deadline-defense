...
public class Tower : MonoBehaviour
{
	...
	public string ShootSound = "Tower";
	...
	void UpdateTarget ()
	{
		GameObject[] enemies = GameObject.FindGameObjectsWithTag(GameManager.EnemyTag);
    ...
    void Shoot ()
	{
        ...
        FindFirstObjectByType<AudioManager>().Play(ShootSound);
    }
